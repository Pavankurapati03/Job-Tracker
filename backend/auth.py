...
SECRET_KEY = os.getenv("JWT_SECRET", "SUPER_SECRET_SECURITY_KEY_FOR_JWT_TOKEN_SIGNING_12345")
ALGORITHM = "HS256"
...
def verify_password(plain_password: str, hashed_password: str) -> bool:
    """Verify standard plain password against secure hash directly."""
    try:
...
async def get_current_user(token: str = Depends(oauth2_scheme)):
    """FastAPI Dependency to authenticate users via JWT bearer token."""
